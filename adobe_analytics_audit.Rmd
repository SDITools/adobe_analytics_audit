---
title: "NYL Adobe Analytics Audit"
output:
  html_document:
    toc: yes
    df_print: paged
...
<<<<<<< HEAD
  company_id: newyora
  rsid: nylgmadlaunchprod
  google_account: chima.umeakunne@gofurther.com
...
>>>>>>> b41c1dae6d9297157b5dff0328e929b0d31f0344
---
...
googlesheets4::gs4_auth(email = params$google_account)
...
if(params$relative_date == TRUE) {
  end_date <- Sys.Date() - 1
  start_date <- Sys.Date() - 186 #Change to 60  after CR run. #This year to date
} else {
